...
@section('content')
<div class="row">
    <div class="col-12 col-sm-12 col-lg-12" data-toggle="modal" data-target="#modalMerk">
        <div class="card">
            <div class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i>Tambah Merk</div>
        </div>
    </div>
</div>
<div class="row">
