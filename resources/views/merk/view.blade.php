...
@section('judul', 'KAI Inventaris - Merk Barang')
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a type="button" class="btn btn-icon icon-left btn-warning" href="/jenis"><i
                                class="fa fa-arrow-left"></i>Kembali</a>
                        <a type="button" data-toggle="modal" data-target="#modalMerk"
                            class="btn btn-icon icon-left btn-primary" href="create"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" class="form-horizontal" role="form" action="{{ url('/merk') }}"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="kode_jenis" class="form-control"
                                        value="{{ $jenis->kodeJenis }}" readonly>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Jenis Barang</label>
                                <div class="input-group">
                                    <input type="text" name="nama_jeni" class="form-control"
                                        value="{{ $jenis->jenisBarang }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Masukkan Nama Merk" name="namaMerk"
                                    required>
                            </div>
                        </div>
