                            ...
                            <tbody>
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->pengguna }}</td>
                                        <td>{{ $data->status }}</td>
                                        <td>{{ $data->noInventory }}{{ $data->urut }}</td>
                                        <td class="btn-group mb-3" role="group">
                                            <a href="/data/{{ $data->idBarang }}/printData" type="button" class="btn btn-primary"> <i
        ...
        <div class="card-body">
            <form data-parsley-validate method="POST" action="{{ url('/data') }}" enctype="multipart/form-data"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="kode_jenis" id="kode_jenis" class="form-control select2">
                            ...
                            @foreach ($jenis as $jns)
                                <option value="{{ $jns->kodeJenis }}">{{ $jns->kodeJenis }} -
                                    {{ $jns->jenisBarang }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" id="series"
                        name="series" placeholder="Masukkan Series">
                </div>
                <div class="form-group">
                    <label for="series">Serial Number</label>
                    <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control"
                        id="serialNumber" name="serialNumber" placeholder="Masukkan Serial Number">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" id="ket"
